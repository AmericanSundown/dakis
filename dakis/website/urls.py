...
urlpatterns = [
    ...
    url(r'^api/exp/(?P<exp_id>\d+)/add-property/', views.add_exp_property, name='add-exp-property'),
    url(r'^api/exp/(?P<exp_id>\d+)/remove-property/(?P<prop_id>\d+)/', views.remove_exp_property, name='remove-exp-property'),
